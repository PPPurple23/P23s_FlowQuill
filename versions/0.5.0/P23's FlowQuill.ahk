...
appversion = 0.5.0
appbuilddate = 2025년 1월 7일
appupdatedetails = `n*If 탭 추가`n　조건문 기능들이 추가되었습니다.`n*변수 기능 추가`n　아래의 목록에 변수를 사용할 수 있는 기능이 추가되었습니다.`n`n(Window 탭의 창 이름`, Message Box 제목과 내용`, Run 탭의 파일/URL`, SoundPlay 탭의 파일 이름`, Send 탭)`n`n*Info 메뉴 수정`n　Run과 Info 문서 추가 및 Delay 문서 이름 변경`n*단축키 변경`n　라인 복사/붙여넣기 단축키와 문서 단축키 제거
...
Gui, Add, Tab2, x622 y9 w490 h480 vTB2 gTB2, Mouse|Bezier Move|Send|SoundPlay|Run|Message Box|Loop|If|Delay|Window
...
Gui, Add, DropDownList, x766 y248 w200 Choose1 vDDL_SVR, current_line|depth|index|isvalid|A_ScriptDir|A_WorkingDir|A_Clipboard|A_ClipboardAll|A_ComputerName|A_Language|A_Hour|A_Min|A_MSec|A_Now|A_Sec|A_DD|A_MM|A_YYYY
